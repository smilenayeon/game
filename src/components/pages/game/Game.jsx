...
function Game() {
  ...
  const sentenceDeck = dataItems.map(dataItem => ({
    ...dataItem,
    type: "sentence"
  }));
  ...
  return (
    <div className="game">
      <div className="card-stage">
        {gameCards.map((gameCard, index) =>
          <GameCard
            ...
            content={
              gameCard.type === "word" ? gameCard.word : gameCard.sentence
            }
      ...
      <div className="side-info">
        ...
        <button className="learn-again-button" onClick={learnAgain}>
          Learn again
        </button>
      </div>
    </div>
